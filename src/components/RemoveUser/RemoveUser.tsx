...
function RemoveUser(props: any) {
  const { openModal, closeModal, onRemoveButtonClick, isRemovingUserLoading } =
    props;
  ...
  return (
    ...
    >
      <>
        ...
        <RemoveUserButton
          label="Remove"
          handleClick={onRemoveButtonClick}
          sx={{ fontSize: '16px', color: 'text.title' }}
          isDisabled={isRemovingUserLoading}
          isLoading={isRemovingUserLoading}
        >
          Remove User
        </RemoveUserButton>
        <CancelButton
